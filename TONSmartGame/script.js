...
buyBtn1.addEventListener("click", function(){
    if(tg.MainButton.isVisible){
        ...
        tg.MainButton.setText("You chose table 1!");
        item = "1";
        tg.MainButton.show()
    }
})
buyBtn2.addEventListener("click", function(){
    if(tg.MainButton.isVisible){
        ...
        tg.MainButton.setText("You chose table 2!");
        item = "2";
        tg.MainButton.show()
    }
})
buyBtn3.addEventListener("click", function(){
    if(tg.MainButton.isVisible){
        ...
        tg.MainButton.setText("You chose table 3!");
        item = "3";
        tg.MainButton.show()
    }
})
buyBtn4.addEventListener("click", function(){
    if(tg.MainButton.isVisible){
        ...
        tg.MainButton.setText("You chose table 4!");
        item = "4";
        tg.MainButton.show()
    }
})
